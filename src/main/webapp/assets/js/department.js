...
$(function(){
    ...
    $("#add_dep").click(function(){
        ...
        // alert(dep_name+"/"+dep_score+"/"+dep_status);
    })
    $("#cancel_dep").click(function(){
        if(confirm("취소하시겠습니까?\n(입력된 정보는 저장되지 않습니다.")== false) return;
        $("#dep_name").val("");
        $("#dep_score").val("");
        $("#dep_status").val("1").prop("selectd", true);
        
        $(".popup_wrap").removeClass("open");
    });
    $(".delete_btn").click(function(){
        if(confirm("학과를 삭제하시겠습니까?") == false) return;
    ...
    $(".modify_btn").click(function(){
        ...
        $.ajax({
            ...
            success:function(r) {
                ...
                $("#dep_score").val(r.data.di_score);
                $("#dep_status").val(r.data.di_status).prop("selectd", true);
            }
        })
    })
